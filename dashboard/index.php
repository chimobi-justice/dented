        ...
        <div class="container-fluid" id="postjob-container">
            <div class="row postjob-wrapper">
                <?php foreach($userPosts as $post) : ?>
                    <div class="col-md-6 col-sm-12 col-xm-12 postjob-card-container">
                        <div class="postjob-card d-flex justify-content-between">
                            <div class="p-3 text-dark">
                                ...
                                <h6><?php echo htmlspecialchars($post['job_role']); ?></h6>
                                <h6><?php echo htmlspecialchars($post['job_time']); ?></h6>
                                <small><?php echo htmlspecialchars($post['job_description']); ?></small>
                            </div>
                            <div class="p-3">
